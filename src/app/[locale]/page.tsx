      ...
      <section className="hero home-magic-hero">
        <div className="hero-magic-copy">
          ...
          <div className="hero-about">
            ...
            <img className="hero-about-avatar" src="/images/profile/profile-sakura.jpeg" alt={t('avatarAlt')} width={72} height={72} />
            <div>
              <p className="hero-about-eyebrow">Ordinary Magic Learner</p>
              <p>{t('bio')}</p>
              <p>{t('siteNote')}</p>
            </div>
          </div>
